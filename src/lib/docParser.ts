...
import { PDFs_IGNORADOS } from './blacklist';
...
// ==============================================================
// 📄 EXTRATOR DE TEXTO BRUTO (Módulo Genérico)
// ==============================================================
export async function extrairTextoBruto(url: string): Promise<string | null> {
  if (PDFs_IGNORADOS.includes(url)) return null;
